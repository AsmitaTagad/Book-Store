...
const Home = () => {
  return (
    <>
    <div className="flex bg-[#ffffff] flex-col gap-[32px] relative z-0">
      <div
        className="w-full flex h-[580px]  pt-[105px] justify-center"
        style={{
      ...
      >
        <div className="absolute z-20 text-[#fff] flex flex-col justify-center items-center w-full gap-[12px] leading-tight">
          <div className="text-[#FF7700] font-600 text-[48px] leading-tight">
            {" "}
            The Book Lover's Dreamlands Awaits!
          </div>{" "}
          <br />
          <div className="flex flex-col justify-center items-center gap-[2px] m-0 p-0 text-[20px] leading-tight">
            ...
            <div className="flex flex-col gap-[40px]">
              <div className="flex flex-col justify-center gap-[20px] leading-tight ">
                ...
                <div className="text-[#fff] font-400 p-0 m-0 leading-tight">
                  Buy your favorite books online with ease! Enjoy exclusive
                  offers <br />
